...
@Service
class FlowableService(private val runtimeService: RuntimeService) {
    ...
    fun startUserEvaluation(name: String, age: Int,membershipType:String, status: String, discount: Double): Map<String, Any> {
        ...
        val processInstance = runtimeService.startProcessInstanceByKey(
            ...
            mapOf("name" to name, "age" to age, "status" to status, "membershipType" to membershipType, "discount" to discount)
        )
